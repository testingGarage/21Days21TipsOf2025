...
# Day 15 - The PR is a proposal for code merge. Don't be confused when you hear "Pull Request" and "Merge Request".
...
**Both PR and MR is for merging a branch code with main branch through GUI of GitHub and GitLab** on successful code review and pipeline tests.  

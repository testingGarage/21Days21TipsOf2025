...
I see, the hestitation arises due to unaware of language and its words.  Be it human to human communication, or human and other system communication.  Git is no excpetion to it. Understanding some of the often used words in Git is helpful to continue using it without getting intimidated.

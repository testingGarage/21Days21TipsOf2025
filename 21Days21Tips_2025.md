...
In the begining days, it is the common experience for a Test Engineer to be confused and unsure of what she or he has locally, and, what is in remote. It is a phase that all of us go through when we are collaborating, committing, pushing and making a PR.  This is very much evident when you want to pull something from your recent branch and look at particular commit.

To help you and me in such case, the **.git** folder holds the information.  This folder is hidden by default in the file system of an OS.
...
Observe the data in these two refs folder.  Look at the latest commit id in these two folders for the branch you are concerned.  If the commit id present in /objects/refs/heads/<branch-name> is not matching with /logs/refs/heads/<branch-name> and /logs/refs/remotes/origin<branch-name>, there is something missing.  

This simple **debugging** can be done with the help of last commit id hash that you got.

Note: Refer to the above picture showing the tree structure of .git.
...
![The refs detail returned from local working directory.](/resources/day9TipPic_dotGitFolderTreeStructure.png "The refs detail returned from local working directory.")
    ...
    - This is the reality and truth on my machine and working directory
        ...
        - Am I missing to switch into right branch after the pull?
            ...
            - After a fetch, you see local refs not having a branch name?
                - **This is one of the place where a Test Engineer fetching to local can miss that thing which was pushed other Test Engineer on a branch.**
                - Know the right remote branch.
                    - On successful fetch, what do I see under local refs?
                    - Further, look at the latest commit ids.
                    - This is a heuristic to start exploring when you are confused if you have it or not in your local.

...
3. ```index 10df5d9..31c6a32 100644```
    ...
    - 'index' is the current working tree reference where the change is staged.
...
8. The line ```## Reading the '''diff'''``` indicates, the start of showing the contents which differ.
